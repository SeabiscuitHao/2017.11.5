<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\www\youme\think\public/../application/admin\view\tags\lst.html";i:1509370984;s:68:"F:\www\youme\think\public/../application/admin\view\common\head.html";i:1509360873;s:68:"F:\www\youme\think\public/../application/admin\view\common\left.html";i:1509370159;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo url('tags/add'); ?>"><i class="icon-font"></i>新增标签</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td title="<?php echo $vo['tagname']; ?>"><a target="_blank" href="#" title="<?php echo $vo['tagname']; ?>"><?php echo $vo['tagname']; ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="<?php echo url('tags/edit',array('id' => $vo['id'])); ?>">修改</a>
                                <a class="link-del" href="<?php echo url('tags/del',array('id' => $vo['id'])); ?>">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div class="list-page"><?php echo $tags -> render(); ?></div>
                </div>
            </form>
        </div>
    </div>
